<div class="row">
    <div class="col-md-12">
        <div class="text-center">
            <img src="img/11.jpg" alt="Rommy agung wijayanto" width="160" class="rounded-circle">
            <table class="table mt-4" style="width:100%; margin:0 auto;">
                <tbody>
                    <tr>
                        <td align="right" width="50%"><strong>NIK / NIDN :</strong></td>
                        <td align="left" width="50%">16630946</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%">rommy agung wijayanto</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Tempat, Tanggal Lahir :</strong></td>
                        <td align="left" width="50%">banjarmasin,22 februari 1998</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Telepon :</strong></td>
                        <td align="left" width="50%">085249664677</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>email :</strong></td>
                        <td align="left" width="50%">rommyagungwijayanto@gmail.com</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Media Sosial :</strong></td>
                        <td align="left" width="50%">
                            <a href="http://facebook.com/Rommy Agung Wijayanto" target="_blank" style="text-decoration:none;">
                                <img src="img/svg/036-facebook.svg" width="30" alt="facebook">
                            </a>
                            <a href="http://instagram.com/rommyagng" target="_blank" style="text-decoration:none;">
                                <img src="img/svg/029-instagram.svg" width="30" alt="instagram">
                            </a>
                            <a href="http://twitter.com/RommyAgung22" target="_blank" style="text-decoration:none;">
                                <img src="img/svg/008-twitter.svg" width="30" alt="twitter">
